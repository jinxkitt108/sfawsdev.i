    ...
    <v-card>
      <v-card-title class="mb-0">
        <h2 class="font-weight-bold basil--text">
          My Store
          <v-btn outlined absolute right to="/marketplace">
            <v-icon class="mr-2">mdi-storefront</v-icon>Build a Store
          </v-btn>
        </h2>
      </v-card-title>
        <v-container class="text-sm-center mt-0" fluid>
          <v-row align="center" justify="center">
            <v-col sm="7">
              <v-avatar size="100">
                <img src="storage/app_photos/leaf-photos.png" />
              </v-avatar>
              <p class="h3 font-weight-bold mb-0" style="color: #0A4D22">Selling made simple.</p>
              <p
              ...
              <v-card class="text-sm-left" style="border: 5px solid teal; border-radius: 20px">
                ...
                <v-alert class="mt-0 mb-0" icon="mdi-account-group">Anyone can sign-up as either individual or corporate seller.</v-alert>
