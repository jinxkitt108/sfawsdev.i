...
<div class="container-fluid pb-2" style="background-image: url(storage/app_photos/Farming.jpg); background-size: cover">
    <div class="row">
        <div class="col-sm-8 my-auto text-white" style="font-size: 64px; font-family: Arial,sans-serif; font-weight: 600;">
                <div class="mx-auto text-left" style="width: 500px">
                    Good <span style="color: #ffa500 ">farming</span>.
                    Good <span style="color: #00ff2b ">life</span>.
                    <h5 class="text-sm-left">SFAWS is a platform inspired by the way you work. From providing you aid to your passion in handling farms and other Agricultural businesses, you can sell and search for supplies or even consult other farmers, suppliers and identified experts.</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <label for="password" class="col-md-4 col-form-label text-md-right small">{{ __('Password') }}</label>
